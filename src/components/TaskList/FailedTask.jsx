...
const FailedTask = ({title,description,date,category}) => {
  return (
    <div className="lg:size-100 size-80 lg:p-5 p-3 bg-red-400 text-black flex-shrink-0 border-2 rounded-xl border-red-800 flex flex-col justify-start gap-10">
